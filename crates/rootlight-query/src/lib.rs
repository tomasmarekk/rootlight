...
pub use model::{
    ...
    CyclePath, DeadCodeCandidate, DeadCodeClassification, ExecutionCompleteness,
    ExecutionCompletenessState, FlowTraceEdge, FlowTraceFrontier, FlowTracePath, FlowTracePlan,
