...
fn golden_label_counts(language: &str) -> BTreeMap<String, usize> {
    let entries: &[(&str, usize)] = match language {
        ...
        "javascript" => &[
            ...
            ("javascript.member_name.reference", 1),
            ("javascript.member_path.reference", 1),
        ...
        "typescript" => &[
            ...
            ("typescript.member_name.reference", 1),
            ("typescript.member_path.reference", 1),
            ("typescript.method.declaration", 1),
            ("typescript.method.scope", 1),
            ("typescript.method_signature.declaration", 1),
            ("typescript.method_signature.scope", 1),
            ("typescript.parameter.declaration", 2),
