...
module.exports = function defineGrammar(dialect) {
  return grammar(JavaScript, {
    ...
    rules: {
      ...
      // The scanner uses this optional, non-emitting context marker to avoid
      // inserting a semicolon before a module's continued `from` clause.
      _from_clause: $ => seq(
        optional($._module_from_context),
        'from',
        field('source', $.string),
      ),
