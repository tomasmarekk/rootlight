...
module.exports = grammar({
  ...
  rules: {
    ...
    // String whitespace is data; extras must not hide raw control characters.
    string: $ => choice(
      seq('"', token.immediate('"')),
      seq('"', $._string_content, token.immediate('"')),
    ),
    ...
    string_content: _ => token.immediate(prec(1, /[^\\"\x00-\x1f]+/)),
