...
enum ts_symbol_identifiers {
  ...
  sym_identifier = 66,
  sym__identifier_escape = 67,
  sym__unescaped_identifier = 68,
  sym_at_keyword = 69,
  sym_js_comment = 70,
  sym_comment = 71,
  sym_plain_value = 72,
...
static const char * const ts_symbol_names[] = {
  ...
  [sym__identifier_escape] = "escape_sequence",
  [sym__unescaped_identifier] = "identifier",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym__identifier_escape] = sym_escape_sequence,
  [sym__unescaped_identifier] = aux_sym_class_name_token1,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [sym__identifier_escape] = {
    .visible = true,
    .named = true,
  },
  [sym__unescaped_identifier] = {
    .visible = true,
    .named = true,
  },
  [sym_at_keyword] = {
  ...
  switch (state) {
    case 0:
      ...
      if (('A' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'd')) ADVANCE(141);
    ...
    case 18:
      ...
      if (lookahead > ',' &&
          (lookahead < ':' || '@' < lookahead) &&
          lookahead != '`' &&
          (lookahead < '{' || 0x7f < lookahead)) ADVANCE(311);
      END_STATE();
    case 19:
      ADVANCE_MAP(
        '#', 189,
    ...
    case 20:
      ...
      if (lookahead > '^' &&
          (lookahead < '`' || 0x7f < lookahead)) ADVANCE(365);
      END_STATE();
    case 21:
      ADVANCE_MAP(
        '(', 205,
    ...
    case 39:
      ...
      if (lookahead > '@' &&
          (lookahead < '[' || '^' < lookahead) &&
          (lookahead < '`' || 0x7f < lookahead)) ADVANCE(473);
      END_STATE();
    case 40:
    ...
    case 43:
      ...
      if (lookahead > '@' &&
          (lookahead < '[' || '^' < lookahead) &&
          lookahead != '`' &&
          (lookahead < '{' || 0x7f < lookahead)) ADVANCE(409);
      END_STATE();
    case 44:
      if (lookahead == '-') ADVANCE(142);
      if (lookahead == '/') ADVANCE(32);
    ...
    case 143:
      ...
      END_STATE();
    case 144:
      if ((!eof && set_contains(sym_plain_value_character_set_1, 10, lookahead))) ADVANCE(481);
      END_STATE();
    case 145:
      if (eof) ADVANCE(148);
      ADVANCE_MAP(
    ...
    case 173:
      ...
      if (((!eof && set_contains(sym_plain_value_character_set_2, 10, lookahead))) &&
          ...
          lookahead != '_' &&
          (lookahead < 'a' || 'z' < lookahead) &&
          (lookahead < 0x80 || 0x10ffff < lookahead)) ADVANCE(481);
      if (lookahead > ',' &&
          (lookahead < ':' || '@' < lookahead) &&
          (lookahead < '[' || '^' < lookahead) &&
          (lookahead < '{' || 0x7f < lookahead)) ADVANCE(349);
      END_STATE();
    case 174:
      ACCEPT_TOKEN(anon_sym_not);
      if (lookahead == '\\') ADVANCE(139);
    ...
    case 301:
      ...
      if ((!eof && set_contains(sym_plain_value_character_set_2, 10, lookahead))) ADVANCE(481);
      END_STATE();
    case 302:
      ACCEPT_TOKEN(sym_unit);
    ...
    case 325:
      ...
      if (set_contains(sym_identifier_character_set_1, 10, lookahead)) ADVANCE(365);
      END_STATE();
    case 326:
      ACCEPT_TOKEN(sym_identifier);
      if (lookahead == '\r') ADVANCE(366);
    ...
    case 366:
      ...
      END_STATE();
    case 367:
      ACCEPT_TOKEN(sym__identifier_escape);
      END_STATE();
    case 368:
      ACCEPT_TOKEN(sym__identifier_escape);
      if (lookahead == '\n') ADVANCE(367);
    ...
    case 374:
      ...
      END_STATE();
    case 375:
      ACCEPT_TOKEN(sym__unescaped_identifier);
    ...
    case 417:
      ...
      if (set_contains(sym_identifier_character_set_1, 10, lookahead)) ADVANCE(473);
      END_STATE();
    case 418:
      ACCEPT_TOKEN(sym_at_keyword);
      if (lookahead == '\r') ADVANCE(474);
    ...
    case 482:
      ...
      if ((!eof && set_contains(sym_plain_value_character_set_2, 10, lookahead))) ADVANCE(482);
      END_STATE();
    case 483:
...
static const TSLexerMode ts_lex_modes[STATE_COUNT] = {
  ...
  [55] = {.lex_state = 146, .external_lex_state = 2},
  ...
  [73] = {.lex_state = 146, .external_lex_state = 2},
  ...
  [240] = {.lex_state = 146, .external_lex_state = 3},
  [241] = {.lex_state = 146, .external_lex_state = 3},
  [242] = {.lex_state = 146, .external_lex_state = 3},
  [243] = {.lex_state = 146, .external_lex_state = 3},
  [244] = {.lex_state = 146, .external_lex_state = 3},
  [245] = {.lex_state = 146, .external_lex_state = 3},
  [246] = {.lex_state = 146, .external_lex_state = 3},
  [247] = {.lex_state = 43},
  [248] = {.lex_state = 23},
  [249] = {.lex_state = 22},
  [250] = {.lex_state = 43},
  [251] = {.lex_state = 146, .external_lex_state = 3},
  [252] = {.lex_state = 146, .external_lex_state = 3},
  [253] = {.lex_state = 146, .external_lex_state = 3},
  [254] = {.lex_state = 25},
  [255] = {.lex_state = 146, .external_lex_state = 3},
  [256] = {.lex_state = 25},
  [257] = {.lex_state = 25},
  [258] = {.lex_state = 25},
  [259] = {.lex_state = 20},
  [260] = {.lex_state = 20},
  [261] = {.lex_state = 146, .external_lex_state = 3},
  [262] = {.lex_state = 25},
  [263] = {.lex_state = 25},
  [264] = {.lex_state = 25},
  [265] = {.lex_state = 25},
  [266] = {.lex_state = 146, .external_lex_state = 3},
  [267] = {.lex_state = 146, .external_lex_state = 3},
  [268] = {.lex_state = 23},
  [269] = {.lex_state = 23},
  [270] = {.lex_state = 23},
  [271] = {.lex_state = 23},
  [272] = {.lex_state = 146, .external_lex_state = 3},
  [273] = {.lex_state = 23},
  [274] = {.lex_state = 23},
  [275] = {.lex_state = 21},
  [276] = {.lex_state = 23},
